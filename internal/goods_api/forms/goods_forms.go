...
type GoodsForm struct {
	...
	Stocks      int32    `form:"stocks" json:"stocks" binding:"required,gte=1"`
	CategoryId  int32    `form:"category" json:"category" binding:"required"`
	MarketPrice float32  `form:"market_price" json:"market_price" binding:"required,gte=0"`
	ShopPrice   float32  `form:"shop_price" json:"shop_price" binding:"required,gte=0"`
