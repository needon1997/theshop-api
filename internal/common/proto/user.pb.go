...
type UserInfoResponse struct {
	...
	Birthday Date   `protobuf:"varint,5,opt,name=birthday,proto3" json:"birthday,omitempty"`
...
func (this Date) MarshalJSON() ([]byte, error) {
	var date = fmt.Sprintf("\"%s\"", time.Unix(int64(this), 0).Format("2006-01-02"))
